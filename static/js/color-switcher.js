...
jQuery(document).ready(function($) {
	...
	$("ul.colors .color3" ).click(function(){
	    $("#colors").attr("href", "/static/css/colors/lightgreen.css");
		return false;
	});
	$("ul.colors .color4" ).click(function(){
	    $("#colors").attr("href", "/static/css/colors/sky.css");
		return false;
	});	
	"use strict"
...
jQuery('head').append('<link rel="stylesheet" id="colors" href="/static/css/colors/yellow.css" type="text/css" />');
